...
bike1 = Bike(manufacturer1, "CR125", "2 Stroke Motocross", 2500, 5000, 10, 50)
bike_repository.save(bike1)

bike2 = Bike(manufacturer2, "KXF250", "4 Stroke Motocross", 3000, 6000, 10, 50)
bike_repository.save(bike2)

bike3 = Bike(manufacturer3, "R1", "4 Stroke Road", 3500, 7000, 10, 50)
